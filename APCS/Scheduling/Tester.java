...
//
//        System.out.println("\t\t\t\t" + "1A" + "\t" + "1B" + "\t" + "2A" + "\t" + "2B" + "\t" + "3A" + "\t" + "3B" + "\t" + "4A" + "\t" + "4B" + "\t" + "5A" + "\t" + "5B" + "\t" + "6A" + "\t" + "6B" + "\t" + "7A" + "\t" + "7B" + "\t" + "8A" + "\t" + "8B");
...
//                    if ((students.get(j).stuConflicts.get(k).contains(conflictedCourses.get(i)) && !(conflictedCourses.get(i).conflictedStudents.contains(students.get(j))))) {
...
//
//        for (int i = 0; i < conflictedCourses.size(); i++) {
//            System.out.println(conflictedCourses.get(i).name + " - " + conflictedCourses.get(i).numStudentsConflicted + " - " + conflictedCourses.get(i).conflictedStudents);
//        }
//
//        for (int i = 0; i < conflicts.size(); i++) {
...
//        for (int i = 0; i < conflicts.size(); i++)
//            System.out.println(numConflictedGroup.get(i) + " students conflicted - " + conflicts.get(i) + " - " + conflictedStu.get(i));
//
//    }
//
...
//            {
//                if (master.get(i).roster.get(j).grade == x) { //Checking for inclusive classes
//                    if (master.get(i).name.charAt(master.get(i).name.length-1)=="I")
//                        for(Course c : master)
//                            if(c.name==master.get(i).name.substring(0, master.get(i).name.length-1))
...
//                        for (int e = d + 2; e <= 13; e += 2) {
//                            for (int f = e + 2; f <= 15; f = f + 2) {
//                                //System.out.println(c+" "+(c+1)+" "+d+" "+(d+1)+" "+e+" "+(e+1)+" "+f+" "+(f+1));
//                                ArrayList<ArrayList<Integer>> trying = new ArrayList<>();
//                                ArrayList<Integer> trying1 = new ArrayList<>();
//                                trying1.add(c);
//                                trying1.add(c + 1);
...
//                            for (int e = d + 2; e <= 13; e += 2) {
//                                for (int f = e + 2; f <= 15; f = f + 2) {
//                                    //System.out.println(b+" "+(b+1)+" "+c+" "+(c+1)+" "+d+" "+(d+1)+" "+e+" "+(e+1)+" "+f+" "+(f+1));
//                                    ArrayList<ArrayList<Integer>> trying = new ArrayList<>();
//                                    ArrayList<Integer> trying1 = new ArrayList<>();
//                                    trying1.add(b);
//                                    trying1.add(b + 1);
...
//                                for (int e = d + 2; e <= 13; e += 2) {
//                                    for (int f = e + 2; f <= 15; f = f + 2) {
//                                        //System.out.println(a+" " + (a+1)+" "+b+" "+(b+1)+" "+c+" "+(c+1)+" "+d+" "+(d+1)+" "+e+" "+(e+1)+" "+f+" "+(f+1));
//                                        ArrayList<ArrayList<Integer>> trying = new ArrayList<>();
//                                        ArrayList<Integer> trying1 = new ArrayList<>();
//                                        trying1.add(a);
//                                        trying1.add(a + 1);
